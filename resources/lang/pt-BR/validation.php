...
return [
    ...
    'attributes'           => [
        ...
        'lat'                     => 'Latitude',
        'long'                    => 'Longitude',
        'opening_time'            => 'Hora Abertura',
        'closing_time'            => 'hora Fechamento',
        ...
        'area'                    => 'Area',
        'areas'                   => 'Areas',
        'shop-product'            => 'Producto de Loja',
        'shop_id'                 => 'Loja',
        'shops'                   => 'Lojas',
        'shopproducts'            => 'Productos de Loja',
        ...
        'phone'                   => 'Telefone',
        'address'                 => 'Endereço',
        'emailsettings'           => 'Configuração Email',
        'sms_settings'            => 'Configuração SMS',
        'whatsapp-setting'        => 'Configuração WhatsApp',
        'delivery-boys'           => 'Entregador',
        'delivery'                => 'Entrega',
        'transaction'             => 'Transação',
        'sales-report'            => 'Reporte de vendas',
        'stock-report'            => 'Reporte de Stock',
        'purchases-report'        => 'Reporte de compra',
        'mrp'                     => 'MRP',
        'roles'                   => 'Roles',
        'banners'                 => 'Banners',
        'request-withdraw'        => 'Solicitar Retirada',
        'pages'                   => 'Paginas',
        'footer_menu_section_id'  => 'Menu Footer',
        'url'                     => 'URL',
        'collections'             => 'Coleções',
        'date'                    => 'Data',
        'order_notifications'     => 'Notificações de ordem',
        'amount'                  => 'Quantia',
        'payment_settings'        => 'Configurações de pagamento',
        'site_settings'           => 'Configurações de Site',
        'email_settings'          => 'Configurações de Email',
        'notification_settings'   => 'Configurações de Notificação',
        'social_login_settings'   => 'Configurações de Social Login',
        'otp_settings'            => 'Configurações de Otp',
        'homepage_settings'       => 'Configurações de Homepage',
        'social_settings'         => 'Configurações de Social Media',
        'ratings'                 => 'Avaliações',
