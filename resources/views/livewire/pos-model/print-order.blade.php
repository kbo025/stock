            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div id="print_order_body">
                        ...
                        <h6>U: {{auth()->user()->name}}</h6>
                        <h6>T: <?=date('d M Y h:m A')?></h6>
                ...
                <div class="modal-body">
                    <div id="print_bill_body">
                        ...
                        <table id="bill-total-table" class="table table-condensed">
                            ...
                            <tr>
                                <td>{{__('levels.total_payable')}}</td>
                                <td class="text-right">{{currencyFormat($totalAmount)}}</td>
                            </tr>
                            <tr><td colspan="2" class="text-center">{{__('levels.merchant_copy')}}</td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
