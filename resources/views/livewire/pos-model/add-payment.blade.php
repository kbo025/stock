                        ...
                        <div class="col-12">
                            <div class="font16">
                                <table class="table table-bordered table-condensed">
                                    <tbody>
                                    <tr>
                                        <td width="25%" class="pos-table-total-css">{{__('levels.Total Items')}}</td>
                                        <td width="25%" class="text-right"><span id="item_count">{{$totalItem}} ({{$totalQty}})</span></td>
                                        <td width="25%" class="pos-table-total-css">{{__('levels.Total Payable')}}</td>
                                        <td width="25%" class="text-right"><span id="twt">{{currencyFormat($totalAmount)}}</span></td>
                                    </tr>
                                    <tr>
                                        <td class="pos-table-total-css">{{__('levels.Total Customer Credit')}}</td>
                                        <td class="text-right"><span id="total_credit">{{currencyFormat($customerBalance)}}</span></td>
                                        <td class="pos-table-total-css">{{__('levels.Total Paying')}}</td>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="amounts">{{__('levels.Credit Amount')}}</label>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="amount">{{__('levels.Cash Amount')}}</label>
