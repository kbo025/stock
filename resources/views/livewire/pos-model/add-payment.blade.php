                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="amounts">{{__('Credit Amount')}}</label>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="amount">{{__('Cash Amount')}}</label>
