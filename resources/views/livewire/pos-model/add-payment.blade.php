        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">{{__('levels.payment')}}</h4>
                        ...
                        <div class="col-12">
                            <div class="font16">
                                <table class="table table-bordered table-condensed">
                                    <tbody>
                                    <tr>
                                        <td width="25%" class="pos-table-total-css">{{__('levels.total_items')}}</td>
                                        <td width="25%" class="text-right"><span id="item_count">{{$totalItem}} ({{$totalQty}})</span></td>
                                        <td width="25%" class="pos-table-total-css">{{__('levels.total_payable')}}</td>
                                        <td width="25%" class="text-right"><span id="twt">{{currencyFormat($totalAmount)}}</span></td>
                                    </tr>
                                    <tr>
                                        <td class="pos-table-total-css">{{__('levels.total_customer_credit')}}</td>
                                        <td class="text-right"><span id="total_credit">{{currencyFormat($customerBalance)}}</span></td>
                                        <td class="pos-table-total-css">{{__('levels.total_paying')}}</td>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="amounts">{{__('levels.credit_amount')}}</label>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="amount">{{__('levels.cash_amount')}}</label>
