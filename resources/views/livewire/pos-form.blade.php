    ...
    <div class="card-body py-3 px-2">
        <form action="#">
            <div class="card-pos-css">
                <div class="form-group card-form-pos-css">
                    <div class="input-group"  wire:key="customer_id" >
                        <select data-placeholder="Select Customer" required="required" class="form-control  @error('customer_id') is-invalid @enderror" tabindex="-1" aria-hidden="true" id="customerID"  wire:model="customer_id">
                            @if(!blank($users))
                                <option value="1">{{__('Select Customer')}}</option>
                ...
                <div class="form-group card-form-pos-css">
                    <input type="text"  class="form-control @error('reference') is-invalid @enderror" wire:model="reference" placeholder="Reference Note">
                    @error('reference')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="form-group card-form-pos-css">
                    <input type="text" id="productSearch" class="form-control ui-autocomplete-input" wire:model="productSearch" wire:keydown.enter="getProduct" placeholder="Search product by code or name, you can scan barcode too" autocomplete="off">
                </div>
            </div>
            <div id="print">
                <div class=" position-relative ">
                    <div class="table-wrapper-scroll-y my-custom-scrollbar  pos-scroll-css">
                        <table id="posTable" class="table table-striped table-condensed table-hover  list-table">
                            ...
                            <tr class="success">
                                <th>Product</th>
                                <th class="pos-tr-th-css">{{__('Price')}}</th>
                                <th class="pos-tr-th-css">{{__('Tax')}}</th>
                                <th class="pos-tr-th-cssone">{{__('Qty')}}</th>
                                <th class="pos-tr-th-csstwo">{{__('Subtotal')}}</th>
                ...
                <div class="pos-bottom">
                    <table class="table table-condensed totals pos-table-css">
                        ...
                        <tr>
                            <td>
                                <button type="button"   wire:click.prevent="editOrderTax()" class="btn bg-purple btn-block px-0 btn-small pos-button-css">
                                    <span class="sname" id=""> Order Tax <i class="fa fa-edit"></i></span>
                                </button>
                            </td>
                        ...
                        <tr class="success">
                            <td colspan="2" class="pos-total">Total Payable
                        ...
                        <div class="row justify-content-center pos-row-css">
                            <div class="col-4 col-sm-4 col-md-4 px-0 py-0">
                                <div class="btn-group-vertical btn-block">
                                    <button type="button" class="btn btn-danger btn-block px-0 pos-cancel-css" id="cancel-order"  wire:click.prevent="cancelOrder">Cancel</button>
                                </div>

                            </div>
                            <div class="col-4 col-sm-4 col-md-4 pos-col-css">
                                <div class="btn-group-vertical btn-block">
                                    <button type="button" class="btn bg-info btn-block px-0" id="print_order" wire:click.prevent="printOrder()">Print Order</button>
                                    <button type="button" class="btn bg-navy btn-block px-0" id="print_bill" wire:click.prevent="printOrderBill()">Print Bill</button>
                                </div>
                            </div>
                            <div class="col-4 col-sm-4 col-md-4 pos-col-md-css">
                                <button type="button" class="btn btn-primary btn-block px-0 pos-cancel-css" id="payment" wire:click.prevent="paymentModal">Payment</button>
                            </div>
                        </div>
