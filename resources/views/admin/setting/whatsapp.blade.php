            ...
            <div class="card-body">
                <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.setting.whatsapp-update') }}">
                    ...
                    <fieldset class="setting-fieldset">
                        <legend class="setting-legend">{{ __('levels.whatsapp_sms_setting') }}</legend>
                        <div class="row">
                            <div class="col-sm-10">
                                <div class="form-group">
                                    <label for="wati_auth_token">{{ __('levels.wati_auth_token') }}</label> <span
                                        class="text-danger">* {{__('levels.your_wati_whatsapp_auth_token')}}</span>
                                ...
                                <div class="form-group">
                                    <label for="wati_api_endpoint">{{ __('levels.wati_api_endpoint') }}</label> <span
                                        class="text-danger">* {{__('levels.your_wati_whatsapp_endpoint')}}</span>
                                ...
                                <div class="form-group">
                                    <label for="wati_template_name">{{ __('levels.wati_template_name') }}</label> <span
                                        class="text-danger">* {{__('levels.your_wati_whatsapp_template_name')}}</span>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <button class="btn btn-primary">
                                <span>{{ __('levels.update_whatsapp_sms_setting') }}</span>
                            </button>
                        </div>
                    </div>
                </form>
