                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="stripe_disabled" id="stripe_disabled"
                                                        ...
                                                        <option value="1" {{ (old('stripe_disabled', setting('stripe_disabled')) == 1) ? 'selected' : '' }}> {{ __('Enable') }}</option>
                                                        <option value="0" {{ (old('stripe_disabled', setting('stripe_disabled')) == 0) ? 'selected' : '' }}> {{ __('Disable') }}</option>
                                                    </select>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="razorpay_disabled" id="razorpay_disabled"
                                                        ...
                                                        <option value="1" {{ (old('razorpay_disabled', setting('razorpay_disabled')) == 1) ? 'selected' : '' }}> {{ __('Enable') }}</option>
                                                        <option value="0" {{ (old('razorpay_disabled', setting('razorpay_disabled')) == 0) ? 'selected' : '' }}> {{ __('Disable') }}</option>
                                                    </select>
